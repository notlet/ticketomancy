...
module.exports = () => {
    ...
    app.get('/transcript/:id', async (req, res) => {
        ...
        if (!config.tickets.categories[ticket.type].service.map(r => memberData.data.roles.includes(r)).includes(true)) return res.status(403).redirect('https://notlet.dev/error?code=403&nohome=1');
